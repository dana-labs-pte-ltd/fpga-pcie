...
#
# Generated by export_simulation on Thu Jun 06 09:21:58 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './axi4_amm_bridge.sh' script.

./axi4_amm_bridge.sh -reset_run
...
./axi4_amm_bridge.sh -noclean_files

For more information on the script, please type './axi4_amm_bridge.sh -help'.
