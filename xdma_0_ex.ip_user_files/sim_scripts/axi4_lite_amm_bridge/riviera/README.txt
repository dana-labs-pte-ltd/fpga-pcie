...
#
# Generated by export_simulation on Wed Jun 05 14:49:58 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './axi4_lite_amm_bridge.sh' script.

./axi4_lite_amm_bridge.sh -reset_run
...
./axi4_lite_amm_bridge.sh -noclean_files

For more information on the script, please type './axi4_lite_amm_bridge.sh -help'.
